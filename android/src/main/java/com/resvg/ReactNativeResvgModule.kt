...
@ReactModule(name = ReactNativeResvgModule.NAME)
class ReactNativeResvgModule(reactContext: ReactApplicationContext) :
  NativeReactNativeResvgSpec(reactContext) {
  ...
  // lolistream-react-native-resvg.cpp
  ...
  companion object {
    const val NAME = "ReactNativeResvg"

    init {
      System.loadLibrary("lolistream-react-native-resvg")
    }
  }
}