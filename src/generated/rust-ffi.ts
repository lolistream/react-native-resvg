...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_rust_fn_clone_converter(handle: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_rust_fn_free_converter(handle: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_rust_fn_constructor_converter_new(serifFamily: Uint8Array, sansSerifFamily: Uint8Array, cursiveFamily: Uint8Array, fantasyFamily: Uint8Array, monospaceFamily: Uint8Array, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_rust_fn_method_converter_convert(ptr: bigint, svg: Uint8Array, scale: Uint8Array, width: Uint8Array, height: Uint8Array, background: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_rust_fn_method_converter_list_fonts(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_rust_fn_method_converter_register_font(ptr: bigint, font: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_rust_checksum_method_converter_convert(): number;
    ubrn_uniffi_rust_checksum_method_converter_list_fonts(): number;
    ubrn_uniffi_rust_checksum_method_converter_register_font(): number;
    ubrn_uniffi_rust_checksum_constructor_converter_new(): number;
    ubrn_ffi_rust_uniffi_contract_version(): number;
    ubrn_uniffi_internal_fn_method_converter_ffi__bless_pointer(pointer: bigint, uniffi_out_err: UniffiRustCallStatus): UniffiGcObject;
}

// Casting globalThis to any allows us to look for `NativeRust`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeRust` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () => (globalThis as any).NativeRust;
